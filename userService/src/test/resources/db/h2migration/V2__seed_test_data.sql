-- Seed data for the H2 test schema. Ids and bcrypt hashes match the Postgres seed so tests can
-- rely on the same fixed identifiers. ON CONFLICT is dropped: the H2 test database is always fresh.
-- Seed passwords: Elena=Passw0rd!23, Mihai=Passw0rd!24, Cristina=AdminP@ss25
