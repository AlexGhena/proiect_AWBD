...
import transactionService.demo.security.ProblemDetailAccessDeniedHandler;
import transactionService.demo.security.ProblemDetailAuthenticationEntryPoint;
...
/**
 * transactionService as a JWT resource server. It never sees a password: it only verifies tokens minted
